    ...
    return (
        <div className="w-4/5 mx-auto py-10">
            <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">Discover the next big opportunity</p>
            </div>

            <div className="grid md:grid-cols-3 gap-6">
                {homeIdeas.map((idea) => (
                    <Link to={`/ideas/${idea.id}`} key={idea.id}>
                        <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow overflow-hidden border">
            ...
            <div className="text-center mt-8">
                <Link to="/ideas" className="inline-flex items-center gap-2 btn bg-black text-white hover:bg-gray-800">
                    View All Ideas
                    <FiArrowRight />
                </Link>
            </div>
