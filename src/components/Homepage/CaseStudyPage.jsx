...
const caseStudies = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1600180758890-6b94519a8ba6?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
  ...
  },
  {
    ...
    author: "Luc",
    income: "$4K/month",
    points: ["Launching on Product Hunt", "Creating a profitable newsletter"],
    image:
      "https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    fullName: "Luc Bennet",
