    ...
    <div className="border-t shadow-inner ">
      <footer className="footer text-base-content p-10">
        ...
        <nav>
          ...
          <Link to="/guides" className="link link-hover">
            Guides
          </Link>
      ...
      <div>
        <aside className="bg-base-200 text-center py-2">
    <p>Copyright © {new Date().getFullYear()} - All right reserved by StartUp Ltd</p>
  </aside>
        </div>
    </div>
  );
